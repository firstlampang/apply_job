class FittingController < ApplicationController
  ...
  def create
    ...
    json = params.permit(:question1, :question2, :question3, :question4, :question5, :question6,
        :question8, :question9, :question11, :question14, :question15, :question17, :question18,
        :question19, :question20, :question21, :question23, :start24, :question25,
        :question26, :question27, :question28, :question29, :question30, :question31, :question32, :question33,
        :question34, :question35, :start36, :question37, :question38, :question39, :question40, :question41, :question42, question10: [],question12: [], question13: [], question16: [], question22: [])
